...
const imgClose = imgPopup.querySelector('.img-popup__close');
const imgPopupSrc = imgPopup.querySelector('.img-popup__image');
const imgPopupTxt = imgPopup.querySelector('.img-popup__subline');
